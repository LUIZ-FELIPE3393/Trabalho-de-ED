...
void atualizarRegistroAtendimento(Atendimento* a)
{
    ...
    for (i = 0; i < tamVetAten; i++)
    {
        //Registrar todos os registros na memória
        if (a[i].numero != 0)
        {
...
void registrarAtendimento(Atendimento *a)
{
    ...
    //Ler a partir do início do arquivo
    fseek(arquivo_atendimento, 0, SEEK_SET);
}

void alocarRegistroAtendimento(Atendimento* a)
{
    //Caso NÃO seja a primeira vez que se aloca registros no tempo de execução
    if (tamVetAten != 0)
    {
        int i;
        for (i = 0; i < tamVetAten; i++)
        {
            //Insere os valores da entrada no arquivo para as variáveis de um registro
    ...
    //Caso seja a primeira vez que se aloca registros no tempo de execução
    do
    {
        //Insere os valores da entrada no arquivo para as variáveis de um registro
        ...
        {
            //Põe a variável de comando no valor correto
